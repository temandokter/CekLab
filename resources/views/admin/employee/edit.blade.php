                    ...
                    <div class="box-body">
                        <div class="form-group col-md-6">
                            <label for="nama_pegawai">Nama Pegawai</label>
                                <input type="text" class="form-control {{ $errors->has('nama_pegawai') ? 'is-invalid' : '' }} " name="nama_pegawai" id="nama_pegawai" placeholder="Masukkan nama pegawai" value="{{ old('nama_pegawai') ??$employee->nama_pegawai }}">
